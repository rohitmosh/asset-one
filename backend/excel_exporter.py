...
def export_assets_to_excel(instances: list[models.AssetInstance]) -> bytes:
    ...
    # Header: Deep Forest Green (#166534)
    ...
    for idx, inst in enumerate(instances, 1):
        ...
        if warranty_end:
            ...
            if days_remaining < 0:
                warranty_cell.fill = red_fill  # Expired
            elif days_remaining <= 30:
                warranty_fill_color = PatternFill(start_color="FF8C00", end_color="FF8C00", fill_type="solid") # Dark Orange
                warranty_cell.fill = warranty_fill_color
            elif days_remaining <= 60:
                warranty_fill_color = PatternFill(start_color="FFD700", end_color="FFD700", fill_type="solid") # Gold / Yellow
                warranty_cell.fill = warranty_fill_color
                
        # Format alignment and border for all cells in row
